        ...
        try {
            ...
            for (int i = 0; i < key.length; i++) {
                if (messageIndex < secretMessage.length()) {
                    ...
                    // Заменяем младший значащий бит текущего байта следующим битом секретного сообщения
                    ...
                    // Увеличим индекс сообщения (для взамодействия со следующим символом строки)
                    messageIndex++;
                }
            }
            
            // Запишем шапку изображения и измененные байты изображения в новый файл
            ...
            String hexRetrived = byteArrayToHexString(newStringBytes);
            
            
            System.out.println("Оригинальное сообщение: " + hex);
            System.out.println("Извлеченное сообщение: " + hexRetrived);
